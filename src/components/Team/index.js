            ...
            <div class="container">
                ...
                <div class="row people justify-content-center align-items-center">
                    <div class="col-md-6 col-lg-4 item">
                        <div class="box"><img class="rounded-circle" data-bs-hover-animate="pulse" alt="yo" src={require('../../images/sam.JPG').default}/>
                    ...
                    <div class="col-md-6 col-lg-4 item">
                        <div class="box"><img class="rounded-circle" alt="yolo" data-bs-hover-animate="pulse" src={require('../../images/biswa.jpg').default}/>
